...
// Service is the per-type configuration for TCP services.
type Service struct {
	// Shared fields
	Name    string
...
// Handler is a TCP handler with optional pattern-based matching.
type Handler struct {
...
func (c *Service) ServiceType() string                    { return "tcp" }
...
// Decode decodes an HCL block body into a TCP Config.
